...
export function getDefaultCardSubtemplate(_type){
    if(defaultCardSubtemplatesMap.has(_type)){
        return defaultCardSubtemplatesMap.get(_type);
    }
...
export function hasDedicatedSubtemplate(_type){
    if(dedicatedSubtemplatesMap.has(_type)){
        return true;
    }else return false;
}
...
export function getDedicatedSubtemplate(_type){
    if(dedicatedSubtemplatesMap.has(_type)){
        return dedicatedSubtemplatesMap.get(_type);
    }
}
