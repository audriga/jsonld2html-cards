...
/* eslint no-undef: "off"
    --------
    Commented out cards will be undefined. */
...
import cardReservation from '../templates/Reservations.html'
...
import subFlightReservation from '../templates/schema_org/sub_FlightReservation.html'
import subEventReservation from '../templates/schema_org/sub_EventReservation.html'
import subReservation from '../templates/schema_org/sub_Reservation.html'
import subTrainReservation from '../templates/schema_org/sub_TrainReservation.html';
import subBusReservation from '../templates/schema_org/sub_BusReservation.html';
...
if(typeof cardReservation !== 'undefined'){
    availableTemplates.set("https://ld2h/Reservations", cardReservation);
    availableTemplates.set("Reservation", cardReservation);
    availableTemplates.set("FlightReservation", cardReservation);
    availableTemplates.set("TrainReservation", cardReservation);
    availableTemplates.set("BusReservation", cardReservation);
}
...
if (typeof subFlightReservation !== 'undefined') {
...
if (typeof subEventReservation !== 'undefined') {
...
export function hasSubtemplateOfType(jsonLdType){

    return availableSubtemplates.has(jsonLdType)
 
}
export function hasTemplateOfType(jsonLdType){
